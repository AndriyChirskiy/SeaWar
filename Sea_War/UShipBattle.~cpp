...
Form2->Memo2->Lines->LoadFromFile("rahunok/difference.txt");
Form2->Memo1->Lines->LoadFromFile("rahunok/results.txt");
...
Form2->Memo1->Lines->SaveToFile("rahunok/results.txt");
 Form2->Memo2->Lines->SaveToFile("rahunok/difference.txt");
}
...
if (Form1->Edit1->Text =="") ShowMessage("Спочатку введіть своє ім'я");
                ...
                Form1->Label9->Caption=Form1->Label2->Caption+
                ", для початку гри зайдіть в меню і натисніть 'Розпочати' ";
